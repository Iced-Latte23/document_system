...
<head>
    ...
    <style>
        ...
        /* Disable interaction with the comment section when blurred */
        .comment-section.blurred {
            position: relative;
            pointer-events: none;
        }

        .comment-section.blurred .comment-overlay {
            display: flex;
            pointer-events: auto;
        }

        .comment-section.blurred #comments-list,
        .comment-section.blurred #comment-form {
            filter: blur(2px);
        }
...
<body>
    <div class="container">
        ...
        <div class="comment-section">
            <h2>Comments</h2>
            <!-- Blur overlay and message -->
            <div class="comment-overlay">
                <p>Comments are reserved for members.</p>
                <a href="signup.php" class="signup-button">Sign up today!</a>
            </div>
            <!-- Comments List -->
    ...
    <script>
        ...
        // Apply blur effect if the user is not logged in
        if (!isLoggedIn) {
