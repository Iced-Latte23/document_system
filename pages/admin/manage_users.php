...
<head>
    ...
    <link rel="stylesheet" href="../../assets/styles/admin/manage_users.css">
...
<body>
    ...
    <script>
        function confirmDelete(userId, userEmail) {
            const loggedInUserId = <?php echo isset($_SESSION['user_id']) ? json_encode($_SESSION['user_id']) : json_encode(0); ?>; // Get the logged-in user's ID

            if (userId === loggedInUserId) {
                showCustomAlert("You cannot delete your own account.");
                return; // Stop further execution
            }

            // Proceed with the confirmation modal
